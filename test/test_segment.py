...
class SegmentTestCase(object):
  ...
  def test_subscribers(self):
    min_date = "2010-01-01"
    self.segment.stub_request("segments/%s/active.json?date=%s&orderfield=email&page=1&pagesize=1000&orderdirection=asc" % (self.segment.segment_id, urllib.parse.quote(min_date)), "segment_subscribers.json")
  ...
  def test_details(self):
    ...
    self.assertEqual(res.RuleGroups[0].Rules[0].Clause, "CONTAINS @hello.com")
