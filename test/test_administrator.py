...
class AdministratorTestCase(object):
  ...
  def test_get(self):
    ...
    self.administrator.stub_request("admins.json?email=%s" %urllib.parse.quote(email), "admin_details.json")
  ...
  def test_update(self):
    ...
    self.administrator.stub_request("admins.json?email=%s" % urllib.parse.quote(self.administrator.email_address), None)
