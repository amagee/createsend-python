...
class AuthenticationTestCase(unittest.TestCase):
  ...
  def test_exchange_token_success(self):
    ...
    self.assertEqual(self.cs.faker.actual_body, "grant_type=authorization_code&client_id=8998879&client_secret=iou0q9wud0q9wd0q9wid0q9iwd0q9wid0q9wdqwd&redirect_uri=http%3A%2F%2Fexample.com%2Fauth&code=98uqw9d8qu9wdu")
  ...
  def test_echange_token_failure(self):
    ...
    self.assertEqual(self.cs.faker.actual_body, "grant_type=authorization_code&client_id=8998879&client_secret=iou0q9wud0q9wd0q9wid0q9iwd0q9wid0q9wdqwd&redirect_uri=http%3A%2F%2Fexample.com%2Fauth&code=invalidcode")
  ...
  def test_can_authenticate_by_calling_auth_with_api_key(self):
    ...
    self.assertEqual(self.cs.headers['Authorization'], "Basic %s" % base64.b64encode("%s:x" % self.api_key_auth_details['api_key']))
  ...
  def test_can_authenticate_by_calling_auth_with_oauth_credentials(self):
    ...
    self.cs.stub_request("systemdate.json", "systemdate.json")
    systemdate = self.cs.systemdate()
    self.assertEqual(self.cs.headers['Authorization'], "Bearer %s" % self.oauth_auth_details['access_token'])
    self.assertEqual(systemdate, "2010-10-15 09:27:00")
  ...
  def test_refresh_token(self):
    ...
    self.assertEqual(self.cs.faker.actual_body, "grant_type=refresh_token&refresh_token=5S4aASP9R%2B9KsgfHB0dapTYxNA%3D%3D")
