...
class ClientTestCase(object):
  ...
  def test_details(self):
    ...
    cl = self.cl.details()
    self.assertEqual(cl.ApiKey, "639d8cc27198202f5fe6037a8b17a29a59984b86d3289bc9")
    self.assertEqual(cl.BasicDetails.ClientID, "4a397ccaaa55eb4e6aa1221e1e2d7122")
  ...
  def test_campaigns(self):
    ...
    self.assertEqual(campaigns[0].CampaignID, 'fc0ce7105baeaf97f47c99be31d02a91')
    self.assertEqual(campaigns[0].WebVersionURL, 'http://createsend.com/t/r-765E86829575EE2C')
    self.assertEqual(campaigns[0].WebVersionTextURL, 'http://createsend.com/t/r-765E86829575EE2C/t')
  ...
  def test_scheduled(self):
    ...
    self.assertEqual(campaigns[0].ScheduledTimeZone, "(GMT+10:00) Canberra, Melbourne, Sydney")
    self.assertEqual(campaigns[0].CampaignID, "827dbbd2161ea9989fa11ad562c66937")
    ...
    self.assertEqual(campaigns[0].PreviewURL, "http://createsend.com/t/r-DD543521A87C9B8B")
    self.assertEqual(campaigns[0].PreviewTextURL, "http://createsend.com/t/r-DD543521A87C9B8B/t")
    self.assertEqual(campaigns[0].FromName, 'My Name')
    self.assertEqual(campaigns[0].FromEmail, 'myemail@example.com')
    self.assertEqual(campaigns[0].ReplyTo, 'myemail@example.com')
  ...
  def test_drafts(self):
    ...
    self.assertEqual(drafts[0].CampaignID, '7c7424792065d92627139208c8c01db1')
    ...
    self.assertEqual(drafts[0].PreviewURL, 'http://createsend.com/t/r-E97A7BB2E6983DA1')
    self.assertEqual(drafts[0].PreviewTextURL, 'http://createsend.com/t/r-E97A7BB2E6983DA1/t')
  ...
  def test_lists_for_email(self):
    ...
    self.cl.stub_request("clients/%s/listsforemail.json?email=%s" % (self.cl.client_id, urllib.parse.quote(email)), "listsforemail.json")
  ...
  def test_unsuppress(self):
    ...
    self.cl.stub_request("clients/%s/unsuppress.json?email=%s" % (self.cl.client_id, urllib.parse.quote(email)), None)
  ...
  def test_templates(self):
    ...
    self.assertEqual(templates[0].TemplateID, '5cac213cf061dd4e008de5a82b7a3621')
  ...
  def test_set_primary_contact(self):
    ...
    self.cl.stub_request("clients/%s/primarycontact.json?email=%s" % (self.cl.client_id, urllib.parse.quote(email, '')), 'client_set_primary_contact.json')
